<head>
  ...
  <svg id="sbtn" class="searchbtn" version="1.1" viewBox="0.0 0.0 100.0 100.0" fill="none" stroke="none" stroke-linecap="square" stroke-miterlimit="10" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg">
    <clipPath id="p.0">
    ...
    <g clip-path="url(#p.0)">
      ...
      <path fill="#000000" fill-opacity="0.0" d="m15.443569 39.133858l0 0c0 -13.254833 10.745167 -24.0 24.0 -24.0l0 0c6.365196 0 12.469688 2.5285635 16.970562 7.029437c4.5008736 4.5008736 7.029438 10.605366 7.029438 16.970562l0 0c0 13.254833 -10.745167 24.0 -24.0 24.0l0 0c-13.254833 0 -24.0 -10.745167 -24.0 -24.0z" fill-rule="evenodd"/>
      <path stroke="#1f92d5" stroke-width="8.0" stroke-linejoin="round" stroke-linecap="butt" d="m15.443569 39.133858l0 0c0 -13.254833 10.745167 -24.0 24.0 -24.0l0 0c6.365196 0 12.469688 2.5285635 16.970562 7.029437c4.5008736 4.5008736 7.029438 10.605366 7.029438 16.970562l0 0c0 13.254833 -10.745167 24.0 -24.0 24.0l0 0c-13.254833 0 -24.0 -10.745167 -24.0 -24.0z" fill-rule="evenodd"/>
      <path fill="#1f92d5" d="m57.7187 54.776917l21.511814 25.385826l-7.6850433 6.519684l-21.51181 -25.385822z" fill-rule="evenodd"/>
      <path fill="#1f92d5" d="m70.42737 83.39392l0 0c0 -2.7483826 2.2279968 -4.9763794 4.976372 -4.9763794l0 0c1.3198166 0 2.585579 0.524292 3.518837 1.4575424c0.9332504 0.93325806 1.4575424 2.1990204 1.4575424 3.518837l0 0c0 2.748375 -2.2279968 4.976372 -4.9763794 4.976372l0 0c-2.748375 0 -4.976372 -2.2279968 -4.976372 -4.976372z" fill-rule="evenodd"/>
    </g>
  </svg>
  <div style="padding: 15px;" id="sbox" class="SearchMenuDefault">
    <h4>Search active events
    </h4>
    <p>Leave a field as it's default value to ignore it.
    </p>
    <form action="/" method="get">
      ...
      <p class="searchLabel">
        <label for="ft">Opposing team:
        </label>
        <br>
        <input style="margin: 7px;" id="ft" name="fteam" placeholder="Team"/>
      </p>
      <input type="submit"/>
    </form>
  </div>
  <link href="styles.css" rel="stylesheet" />
  <h1>Kenston Athletic Events
  </h1>
  <p>Please note that not all events may be added.
  </p>
  <center>
...
?>
          <a
             <?= $r["active"] == 1? 'href="app?id='.$r["id"].'"' : "" ?>>
          <div
               <?=$r["active"] == 0? 'class="eventcardInactive"':'class="eventcard"'?> class="eventcard" id="event
          <?= $r["id"]; ?>">
          <div class="cardContents">
            <table>
              <tr>
                <td>
                  <div class="gameData">
                    <p style="margin-bottom: 7px;margin-top: 0px;">
                      <?= $r["name"]; ?>
                    </p>
                    ...
                    <div class="gdDetailed">
                      ...
                      <p style="margin-top: 5px;" class="smallTxt">
                        <?= $r["school"] . " " . $tc . " " . $sport ?>
                      </p>
                      <p style="margin-top: 3px;" class="smallTxt">
                        <?= $gtime; ?>
                      </p>
                    </div>
                  </div>
                  ...
                  <div class="cardScores" style="padding: 6px;">
                    <table>
                      <tr>
                        ...
                        <td style="margin-left: 8px;margin-right: 8px;">VS.
                        </td>
                        <td>
...
?>
  ...
  <script>
    var ids = [
      ...
      <?= $row["id"];
    if ($x != $length - 1) {
      // makes sure there isn't a comma at the end of the array initialization.
      print(", ");
    }
    ?>
      <?php
